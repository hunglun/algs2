...
* TODO solve boggle[18%]
1. [X] create stub files
2. [X] understand the problem
3. [ ] understand the solution concept
4. [ ] Familiarize yourself with the BoggleBoard.java data type.
5. [ ] Use a standard set data type to represent the dictionary, e.g.,
